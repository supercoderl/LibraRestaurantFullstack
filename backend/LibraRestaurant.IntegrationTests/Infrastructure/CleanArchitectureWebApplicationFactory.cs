...
namespace LibraRestaurant.IntegrationTests.Infrastructure;

public sealed class LibraRestaurantWebApplicationFactory : WebApplicationFactory<Program>
{
    ...
    public LibraRestaurantWebApplicationFactory(
