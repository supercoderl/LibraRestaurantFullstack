...
{
    public sealed class UpdateOrderLineCommand : CommandBase
    {
        private static readonly UpdateOrderLineCommandValidation s_validation = new();
        ...
        public UpdateOrderLineCommand(
            ...
            CustomerLikeStatus customerLike) : base(orderLineId)
        {
