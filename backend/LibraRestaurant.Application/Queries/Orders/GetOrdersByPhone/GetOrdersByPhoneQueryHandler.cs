...
public sealed class GetOrdersByPhoneQueryHandler :
    IRequestHandler<GetOrdersByPhoneQuery, PagedResult<OrderViewModel>>
{
    private readonly ISortingExpressionProvider<OrderViewModel, OrderHeader> _sortingExpressionProvider;
    private readonly IOrderRepository _orderRepository;

    public GetOrdersByPhoneQueryHandler(
